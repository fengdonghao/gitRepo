 ...
 * @ Author:fdh
 * @ Description:
 * @ Date： Create in 9:54 2018/1/31
 */
public class MatrixToImageWriter1 {
    ...
    private static void applyLogo(BufferedImage image) throws IOException {
        ...
        ClassPathResource resource = new ClassPathResource("/static/username.png");//logo图片
